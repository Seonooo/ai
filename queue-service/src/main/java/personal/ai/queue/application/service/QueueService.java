...
/**
 * Queue Application Service (Deprecated)
 * 
 * @deprecated 이 클래스는 더 이상 사용되지 않습니다.
 *             대신 각 UseCase별로 분리된 서비스를 사용하세요:
 *             - {@link EnterQueueService}
 *             - {@link QueueStatusQueryService}
 *             - {@link TokenActivationService}
 *             - {@link TokenExtensionService}
 *             - {@link TokenValidationService}
 *             - {@link QueueRemovalService}
 */
@Slf4j
@Deprecated
